...
plt.scatter(X_train, y_train, color='blue', label='Learning data', alpha=0.5, s=20)
plt.scatter(X_test, y_test, color='green', label='Testing data', alpha=0.5, s=20)
plt.plot(X_test, y_pred, color='red', label='Prognosis')
plt.xlim(1950)
plt.ylim(40)
plt.xlabel('Customer age')
plt.ylabel('Bicycle accessories and spare parts purchased in past 3 years')
plt.title('Purchase in past 3 years and age analysis\n LinearRegression method')
plt.legend()
plt.show()
